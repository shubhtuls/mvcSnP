...
for param in view_params:
    ...
    camObj.location[0] = cx + random.uniform(-g_camPos_noise,g_camPos_noise)
    camObj.location[1] = cy + random.uniform(-g_camPos_noise,g_camPos_noise)
    camObj.location[2] = cz + random.uniform(-g_camPos_noise,g_camPos_noise)
